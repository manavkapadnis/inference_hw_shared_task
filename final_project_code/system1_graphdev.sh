#!/bin/bash
#SBATCH --job-name=sys1_graphdev
#SBATCH --output=/home/mkapadni/work/inference_algo/homework4/attempt_1/out_file/sys1_graphdev.out
#SBATCH --error=/home/mkapadni/work/inference_algo/homework4/attempt_1/err_file/sys1_graphdev.err
...
python evaluate_local.py \
    ...
    --batch_size 1 \
    --output results/system1_graphdev.json
