#!/bin/bash
#SBATCH --job-name=sys2_graphdev
#SBATCH --output=/home/mkapadni/work/inference_algo/homework4/attempt_1/out_file/sys2_graphdev.out
#SBATCH --error=/home/mkapadni/work/inference_algo/homework4/attempt_1/err_file/sys2_graphdev.err
...
python evaluate_local.py \
    ...
    --use_8bit \
    --batch_size 1 \
    --output results/system2_graphdev.json
