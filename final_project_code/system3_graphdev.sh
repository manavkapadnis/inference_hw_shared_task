#!/bin/bash
#SBATCH --job-name=sys3_graphdev
#SBATCH --output=/home/mkapadni/work/inference_algo/homework4/attempt_1/out_file/sys3_graphdev.out
#SBATCH --error=/home/mkapadni/work/inference_algo/homework4/attempt_1/err_file/sys3_graphdev.err
...
python evaluate_local.py \
    ...
    --use_8bit \
    --batch_size 1 \
    --output results/system3_graphdev.json
