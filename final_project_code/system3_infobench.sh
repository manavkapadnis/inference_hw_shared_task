#!/bin/bash
#SBATCH --job-name=sys3_infobench
#SBATCH --output=/home/mkapadni/work/inference_algo/homework4/attempt_1/out_file/sys3_infobench.out
#SBATCH --error=/home/mkapadni/work/inference_algo/homework4/attempt_1/err_file/sys3_infobench.err
...
python evaluate_local.py \
    ...
    --use_8bit \
    --batch_size 1 \
    --output results/system3_infobench.json
