#!/bin/bash
#SBATCH --job-name=system5_graphdev
...
#SBATCH --output=/home/mkapadni/work/inference_algo/homework4/attempt_1/out_file/system5_graphdev.out
#SBATCH --error=/home/mkapadni/work/inference_algo/homework4/attempt_1/err_file/system5_graphdev.err
...
python evaluate_local.py \
    ...
    --use_enhanced \
    --batch_size 1 \
    --output results/system5_graphdev.json

echo "System 5 GraphDev evaluation complete!"
