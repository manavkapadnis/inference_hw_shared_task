#!/bin/bash
#SBATCH --job-name=system5_infobench
...
#SBATCH --output=/home/mkapadni/work/inference_algo/homework4/attempt_1/out_file/system5_infobench.out
#SBATCH --error=/home/mkapadni/work/inference_algo/homework4/attempt_1/err_file/system5_infobench.err
...
python evaluate_local.py \
    ...
    --use_enhanced \
    --batch_size 1 \
    --output results/system5_infobench.json

echo "System 5 InfoBench evaluation complete!"
