#!/bin/bash
#SBATCH --job-name=system6_graphdev
...
#SBATCH --output=/home/mkapadni/work/inference_algo/homework4/attempt_1/out_file/system6_graphdev_new_function.out
#SBATCH --error=/home/mkapadni/work/inference_algo/homework4/attempt_1/err_file/system6_graphdev_new_function.err
...
echo "System 6 GraphDev evaluation complete!"
