#!/bin/bash
#SBATCH --job-name=system6_infobench
...
#SBATCH --output=/home/mkapadni/work/inference_algo/homework4/attempt_1/out_file/system6_infobench.out
#SBATCH --error=/home/mkapadni/work/inference_algo/homework4/attempt_1/err_file/system6_infobench.err
...
python evaluate_local.py \
    ...
    --use_4bit \
    --batch_size 1 \
    --output results/system6_infobench.json

echo "System 6 infobench evaluation complete!"
